...
const blank: ChildProfileInput = { name: "", age: "", appearance: "", outfit: "", comfortItems: [], companions: [], places: [], mustNotShow: [], calmingRules: [], sensory: { reducedMotion: true, sound: "on", showText: true, largeText: false, pacing: "slow" }, guardian: "", notes: "" };
...
export default function ChildPage() {
  ...
  const save = async () => {
    ...
    try {
      ...
      if (isNew) router.push(`/children/${saved.id}`);
