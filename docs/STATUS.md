...
- [ ] Character reference-image generation for identity anchoring (the Generation Service already passes stored references when present; a "generate character sheet" step is not built)
